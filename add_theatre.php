        ...
        <div class="box-body">
            <form action="process_add_theater.php" method="post" id="form1">
              ...
              <div class="form-group">
                ...
                <input type="text" name="region" id="administrative_area_level_1" s placeholder="Region" class="form-control">
                <?php $frm->validate("region",array("required","label"=>"Region")); // Validating form using form builder written in form.php ?>
              </div>
              <div class="form-group">
                <label class="control-label">Zip Code</label>
                 <input type="text" name="zipcode" id="postal_code"s placeholder="Zip code" class="form-control">
                 <?php $frm->validate("zipcode",array("required","label"=>"Zip Code","regexp"=>"zipcode")); // Validating form using form builder written in form.php ?>
              </div>
              <?php
                start:
